...
namespace RandomGen
{
    class Program
    {
        ...
        //if declared outside of a method BUT within the class THEN the variable is 
        //known to ALL methods WITHOUT having to pass the value as a parameter
        ...
        static void Main(string[] args)
        {
            ...
            //To ge a physical instance of the object use the keyword "new"
        ...
        //static void SomeMethod (Random paraRnd)
        //{
